...
\texttt{Dockerfile}, \texttt{scripts/reproduce\_all.sh} (end-to-end reproduction),
\texttt{scripts/generate\_graphs.py}, and \texttt{scripts/extract\_caida\_subgraph.py}.
MAWI trace-derived CSV data will be deposited on Zenodo upon acceptance; the DOI will be
added at camera-ready stage.
