...
\par\textbf{ANA-MLMC weight sensitivity.} The default
$(\gamma_C,\gamma_V,\gamma_S)=(0.4,0.4,0.2)$ blend was chosen for
balanced behaviour but has not yet been swept across operational
scenarios; an operator using the framework should expect to retune the
weights for their specific SLA priorities.  A sensitivity study and a
cross-validation procedure for the weight selection are obvious
follow-ups.
